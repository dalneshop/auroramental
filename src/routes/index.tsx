  ...
  head: () => ({
    meta: [
      { title: "Aurora Mental — Psicologia Online com Base Científica" },
      {
        name: "description",
        content:
          "Terapia online com TCC, a partir de R$130 a sessão. Agende uma conversa inicial gratuita de 20 minutos (Encontro Aurora) para conhecer o processo.",
      },
    ...
    <div className="aurora-page">
      ...
      <section id="cta-final">
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          ...
          <div className="cta-gratuito">✦ Primeira conversa sem custo · 20 min, depois consultas 50 min a partir de R$ 130,00</div>
